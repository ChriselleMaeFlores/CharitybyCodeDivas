...
<body>
	...
	<img src="bg.png" alt="" class="w-full h-[715px]">
    	<form class="shadow w-450 p-3 my-10 absolute inset-x-[32%] top-[100px] bg-white" 
		  ...
		  <div class="mb-1">
		    ...
		    <input type="text h-8" 
		           class="form-control text-[12px] mt-[-8px] border-gray-300 border-2 "
		           name="uname"
		  ...
		  <div class="mb-1">
		    ...
		    <input type="email" 
		           class="form-control h-8 text-[12px] mt-[-8px] border-gray-300 border-2"
		           name="fname" 
		           value="<?php echo (isset($_GET['fname']))?$_GET['fname']:"" ?>">
		  </div>

		  			<select name="loginas" id=""
                        class="border-2 border-gray-300 text-center w-[420px] h-11 px-4  m-2 mx-auto rounded text-[12px] ">
                        <option value="" sdisabled selected hidden>-------------------------Signup As-------------------------
                        </option>
		  ...
		  <div class="mb-3">
		    ...
		    <input type="password" 
		           class="form-control h-8 text-[12px] mt-[-8px] border-gray-300 border-2"
				   title="Password must contain at least one uppercase letter, one unique character, and consist of alphanumeric characters!"
		           name="pass">
		  </div>

		  
		  
		  <button type="submit" class="rounded-lg bg-pastelred text-white px-4 py-1 hover:bg-japaneseindigo">Sign Up</button>
        ...
        <div class="flex w-5/12 flex-col ms-[85px]"> 
         ...
         <div class="flex w-7/12 h-48 flex-row bg-[#3f4f57] right-3 me-[85px] py-10 px-6 gap-[58px] justify-center">
            ...
            <div class="flex flex-col text-white text-[10px]  gap-[5px] font-medium"> 
                    ...
                    <a href="about.php#who" class="hover:underline hover:text-white font-normal">
                        > Who We Are

                    </a>
                    <a href="about.php#where" class="hover:underline hover:text-white font-normal">
                        > Where We Work
                        
                    </a>
                    <a href="about.php#our" class="hover:underline hover:text-white font-normal">
                        > Our Work
