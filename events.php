...
<style>
    .custom-shape-divider-top-1686809708 {
    position: absolute;
    top: 25rem;
    left: 0;
    width: 100%;
...
.custom-shape-divider-top-1686809708 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-top-1686809708 .shape-fill {
    fill: #ffffff;
}
...
<div class="sticky top-0 flex flex-row col-span-3 h-[1.3rem] bg-middleblue z-30 ">
      ...
      <div class="sticky top-[1.3rem] flex flex-row col-span-3 h-16 bg-white shadow-md z-30 flex-wrap">
          ...
          <div class="w-[48rem] h-16 absolute inset-y-0 right-[85px]">
              <ul class="flex flex-row w-[48rem] h-16 justify-center items-center ">
                  ...
                  <li class="px-3 border-l-[1px] border-japaneseindigo flex justify-center items-center">
                    <a class="font-medium text-pastelred text-[0.8rem] hover:text-pastelred hover:text-[0.85rem]" href="events.php">Events</a>
                  </li>
                  <li class="px-3 border-l-[1px] border-japaneseindigo flex justify-center items-center">
      ...
      <div class="flex flex-col items-center bg-[#218375]">
        <img class="w-fit h-[24rem]" src="event_abi.png" alt="">
      </div>
    ...
    <div class="w-full py-8 flex flex-col items-center ">
        <h1 class="text-4xl font-bold mb-12 py-2 mt-6  text-[#218375] w-full text-center animate-bounce">OUR UPCOMING EVENTS</h1>

        <?php if (!empty($posts)) : ?>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 ">
                <?php foreach ($posts as $post) : ?>
                    <div class="bg-white w-[20rem] min-w-[20rem] mb-10 backdrop-filter backdrop-blur-lg shadow-sm shadow-green-800 rounded-lg" data-aos="flip-up" data-aos-delay="100" data-aos-duration="1000" data-aos-easing="ease-in-out">
                        <div class="overflow-hidden w-[20rem] h-[15rem] rounded-tl-lg rounded-tr-lg mb-2">
                            <img class="w-full h-full object-cover" src="<?=$post['image']?>" alt="">
                        </div>
                        <h2 class="text-xl font-bold mb-5 text-center"><?php echo $post['title']; ?></h2>
                        <p class="px-4 text-[15px] text-justify mb-7 truncate" id="textToTruncate"><?php echo $post['content']; ?></p>
                        <div class="flex flex-row w-full px-4 relative">
                                <div class="flex flex-row gap-1 w-8/12">
                                        <div class="text-[11px] font-bold mb-5">
                                            <?php 
                                        ...
                                        <div class="text-[11px] font-bold"> | 
                                            <?php 
                                                ...
                                                $time = DateTime::createFromFormat('H:i:s.u', $timeString);
                                                $formattedTime = date_format($time, 'g:i a');
                                                echo $formattedTime;
                                            ?>
                                        </div>
                                </div>   
                                <div class="px-4 text-[12px] font-bold absolute right-0 w-5/12 truncate"><?php echo $post['location']; ?></div>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <?php else : ?>
            <p class="mt-5 bg-green-100 text-green-500 border-2 border-x-white border-y-green-500 px-4 py-2 z-20">No posts available.</p>
            <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
            <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_ZJR0xnKKys.json"  background="transparent"  speed="1"  style="width: 500px; height: 500px;" loop autoplay></lottie-player>
...
<div class="flex flex-row col-span-3 h-[15.5rem] bg-japaneseindigo items-center justify-center">
        ...
        <div class="custom-shape-divider-top-1686809708">
