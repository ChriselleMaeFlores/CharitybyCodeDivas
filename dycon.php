...
<div class="sticky top-0 flex flex-row col-span-3 h-[1.3rem] bg-middleblue z-30 ">
      ...
      <div class="sticky top-[1.3rem] flex flex-row col-span-3 h-16 bg-white shadow-md z-30 flex-wrap">
          ...
          <div class="w-[48rem] h-16 absolute inset-y-0 right-[85px]">
              <ul class="flex flex-row w-[48rem] h-16 justify-center items-center ">
                  ...
                  <li class="px-3 border-l-[1px] border-japaneseindigo flex justify-center items-center">
                    <a class="font-medium text-pastelred text-[0.8rem] hover:text-pastelred hover:text-[0.85rem]" href="dycon.php">Events</a>
                  </li>
                  <li class="px-3 border-l-[1px] border-japaneseindigo flex justify-center items-center">
      ...
      <div class="flex flex-col items-center bg-[#218375]">
        <img class="w-fit h-[22rem]" src="event_abi.png" alt="">
      </div>
    ...
    <div class="container mx-auto py-8 flex flex-col items-center bg-slate-100">
        <h1 class="text-4xl font-bold mb-12 py-2 mt-8  text-[#218375] w-full text-center animate-bounce">OUR UPCOMING EVENTS</h1>

        <?php if (!empty($posts)) : ?>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 ">
                <?php foreach ($posts as $post) : ?>
                    <div class="bg-white rounded-lg shadow w-[20rem] min-w-[20rem] mb-10 ">
                        <div class="overflow-hidden w-full h-[15rem] rounded-tl-lg rounded-tr-lg mb-2">
                            <img class="w-auto h-[100%]" src="<?=$post['image']?>" alt="">
                        </div>
                        ...
                        <div class="flex flex-row w-full px-4 relative">
                                <div class="flex flex-row gap-1 w-7/12">
                                        <div class="text-[12px] font-bold mb-5">
                                            <?php 
