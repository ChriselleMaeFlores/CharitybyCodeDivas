...
<div class="sticky top-0 flex flex-row col-span-3 h-[1.3rem] bg-middleblue z-30 ">
	  ...
	  <div class="sticky top-[1.3rem] flex flex-row col-span-3 h-16 bg-white shadow-md z-30 flex-wrap">
		  ...
		  <div class="w-[50rem] h-16 absolute inset-y-0 right-[85px]">
			  <ul class="flex flex-row w-[50rem] h-16 justify-center items-center ">
				  ...
				  <li class="px-[5px] border-l-[1px] border-japaneseindigo flex w-36 justify-center items-center">
				  ...
				  <li class="px-3 border-l-[1px] border-japaneseindigo flex justify-center items-center">
					<a class="font-medium text-japaneseindigo text-[0.8rem] hover:text-pastelred hover:text-[0.85rem]" href="#">Chat</a>
				  </li>
  
				  <li class="mx-1 px-0 w-36 h-[2.5rem] bg-pastelred border-3 hover:bg-japaneseindigo hover:px-[18px] hover:h-[2.7rem] text-center rounded-lg
				  ...
				  <li class="px-3 border-japaneseindigo p-3 flex justify-center items-center">
					  <a class="font-medium text-pastelred text-[0.8rem] hover:text-pastelred hover:text-[0.85rem]" href="login.php">Account</a>
				  </li>
			  </ul>
		  </div>
    ...
    <div class="flex flex-row">
		...
		<img src="bg.png" alt="" class="w-full h-[475px]">
    	
    
        <form class="flex flex-col justify-center items-center shadow w-[350px] h-[300px] p-3 absolute inset-x-[37%] top-[150px] bg-white"  
        method="post" action="#" id="RegForm">

        <h1 class="text-[20px] font-extrabold text-japaneseindigo mb-4">
            ENTER OTP CODE
        </h1>

        <h class="mb-2" style="color: green;font-size: 12px;font-weight: bold;">Please enter the OTP sent to your email!</h>


        <input class="w-full mb-3" type="text" name="otp_code" placeholder="Enter OTP">
        <button type="submit" class="btn bg-middleblue text-japaneseindigo font-bold hover:bg-japaneseindigo hover:text-white shadow" name="continue">Continue</button>
        ...
        <div class="flex w-5/12 flex-col ms-[85px]"> 
         ...
         <div class="flex w-7/12 h-48 flex-row bg-[#3f4f57] right-3 me-[85px] py-10 px-6 gap-[58px] justify-center">
            <div class=" flex-col text-white text-[10px] gap-[5px] ">
                ...
                <div href="" class="hover:underline font-normal mt-1 hover:tex-white">
                    > PWD
                </div>
                <div href="" class="hover:underline font-normal hover:tex-white">
...
<?php 
    ...
    if(isset($_POST["continue"])){
        ...
        ?>
             <script>
                 alert("Verfication account done! Login Successful");
                 window.location.replace("account.php?unique_id=<?php echo $_SESSION['unique_id']?> ");
