...
<div class="flex my-[5rem] justify-center items-center h-[30rem] max-h-[40rem]">
  <div class="wrapper">
    <section class="chat-area">
      <header>
        <?php 
          ...
          $stmt->bindParam(':login_id', $unique_id);
          $stmt->execute();
        ...
        <img src="../profileImages/<?php echo $row['pp']; ?>" alt="">
        <div class="details">
          <span><?php echo $row['username']; ?></span>
          <p><?php echo $row['statuses']; ?></p>
        </div>
      </header>
      <div class="chat-box">
