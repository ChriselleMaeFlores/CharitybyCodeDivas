...
<div class="sticky top-0 flex flex-row col-span-3 h-[1.3rem] bg-middleblue z-30 ">
    ...
    <div class="flex flex-row">
    	...
    	<form class="shadow w-[350px] h-[335px] max-h-[425px] p-3 absolute inset-x-[37%] top-[140px] bg-white" 
    	      action="php/login.php" 
    	      method="post">

    		<h4 class="display-4  fs-1">LOGIN</h4><br>
    		<?php if(isset($_GET['error'])){ ?>
    		<div class="alert alert-danger h-12 text-[14px] -mt-3" role="alert">
			  <?php echo $_GET['error']; ?>
			</div>
		    <?php } ?>
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" 
		           class="form-control w-[313.5px] h-7"
		           name="fname"
		  ...
		  <div class="mb-3">
		    <label class="form-label w-[313.5px]">Password</label>
		    <input type="password" 
		           class="form-control h-7"
		           name="pass">
		  </div>
		  
		  <button type="submit" class=" rounded-lg bg-pastelred text-white px-4 py-1 hover:bg-japaneseindigo">Login</button>
